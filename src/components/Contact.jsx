  ...
  return (
    <div className="w-[30%] mx-auto p-6 bg-white rounded-lg shadow-lg font-serif">
      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-4">
          <label htmlFor="name" className="block text-[#3C3633] font-bold px-2">Name</label>
          <input
            type="text"
            id="name"
            name="name"
        ...
        <div className="mb-4">
          <label htmlFor="email" className="block text-[#3C3633] font-bold px-2">Email</label>
          <input
            type="email"
            id="email"
            name="email"
        ...
        <div className="mb-4">
          <label htmlFor="phone" className="block text-[#3C3633] font-bold px-2">Phone Number</label>
          <input
            type="tel"
            id="phone"
            name="phone"
